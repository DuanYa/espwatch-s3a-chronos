...
// 根据不同硬件平台定义SPI实例
#ifndef LGFX_SPI_DEFAULT_INSTANCE
  #define LGFX_SPI_DEFAULT_INSTANCE SPI2_HOST
#endif
  ...
  {
    {
      ...
      // SPI bus settings
      cfg.spi_host = LGFX_SPI_DEFAULT_INSTANCE; // Select the SPI to use ESP32-S2,C3 : SPI2_HOST or SPI3_HOST / ESP32 : VSPI_HOST or HSPI_HOST
      ...
      cfg.freq_write = 40000000;              // SPI time (up to 80MHz, four or five inputs divided by 80MHz to get an integer)
